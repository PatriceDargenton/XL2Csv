...
Public Class TextEncodingDetect
    ...
    Public Shared Function GetBomLengthFromEncodingMode(encoding As Encoding) As Integer
    ...
    Public Function CheckBom(buffer As Byte(), size As Integer) As Encoding
        ' Check for BOM
    ...
    Public Function DetectEncoding(buffer As Byte(), size As Integer) As Encoding
    ...
    Private Shared Function CheckUtf16NewlineChars(buffer As Byte(), size As Integer) As Encoding
        If size < 2 Then
            Return Encoding.None
        End If
    ...
    ''' <param name="buffer">The byte buffer.</param>
    ''' <param name="size">The size of the byte buffer.</param>
    Private Shared Function DoesContainNulls(buffer As Byte(), size As Integer) As Boolean
        'Dim pos As UInteger = 0
        Dim pos As Integer = 0
        While pos < size
    ...
    ''' <param name="size">The size of the byte buffer.</param>
    ''' <returns>Encoding.none, Encoding.Utf16LeNoBom or Encoding.Utf16BeNoBom.</returns>
    Private Function CheckUtf16Ascii(buffer As Byte(), size As Integer) As Encoding
        Dim numOddNulls = 0
        Dim numEvenNulls = 0
    ...
    ''' </returns>
    Private Function CheckUtf8(buffer As Byte(), size As Integer) As Encoding
